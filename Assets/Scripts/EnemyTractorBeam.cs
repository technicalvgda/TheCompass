...
public class EnemyTractorBeam : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        MAX_TRACTOR_LENGTH = _vision.viewDist;
    }
    ...
    void Update()
    {
        ...
        if (_vision.sight)
        {
            ...
            //for the enemy growing the tractor beam feels weird and throws off the timing 
            RaycastHit2D hit = Physics2D.Raycast(transform.position, _playerPos - transform.position, MAX_TRACTOR_LENGTH);
